...
subtitle: "Yinan Li, Tiffany Luo, Xiaofan Liu， Trevor Kapuvari"
...
# Authenticate
bq_auth(path = "https://raw.githubusercontent.com/YinanLi-15/MUSA509_Marine_Pollution/main/Modeling/keys/musa509-marine-pollution-03c6d9b8bb8f.json")
```
...
```{r load_finalnet_from_local, warning=FALSE, message=FALSE}
# Set the working directory to the 'data' folder
setwd("data")

# Load the 'final_net.csv' file as a data frame
df <- read.csv("final_net.csv")
```
